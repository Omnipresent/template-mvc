...
<head>
	...
	<title><decorator:title default="Template MVC" /></title>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/resources/styles/redmond/jquery-ui-1.8.16.custom.css" />" />
        <link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/resources/styles/ui.jqgrid.css" />" />        
